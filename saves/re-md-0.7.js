      ...
      re-md {
        ...
        * {
        ...
        blockquote {
          ...
          background-color: hsla(from var(--color) h s l / 0.1);
          border-radius: calc(var(--size-unit, 0.5rem) * 0.25);
          border-left: 4px solid hsla(from var(--color) h s l / 0.5);
        }

        code {
          font-size: var(--f-size-p, 1rem);
          padding: calc(var(--space-unit, 0.5rem) * 1/2) var(--space-unit, 0.5rem);
          background-color: hsla(from var(--color) h s l / 0.1);
