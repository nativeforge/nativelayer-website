class docAside extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <style>
      ...
      doc-aside aside {
        li,a { 
          padding: calc(var(--space-unit, 0.5rem) * 2/3) 0;
        ...
        .doc-aside-list {
          ...
          padding-left: var(--doc-aside-padding);
          padding-bottom: calc(var(--space-unit, 0.5rem)* 20);
          overflow-y: auto;
          overflow-x: hidden;
          height: 100%;
          flex: 1;
        ...
        :root h1, :root h2, :root h3, :root h4, :root h5, :root h6 {
          scroll-margin-top: calc(var(--nav-height, calc(var(--space-unit, 0.5rem)* 4)) + var(--space-unit, 0.5rem) * 3) !important;
        }
      }
    </style>
    <aside>
    ...
    this.buildHierarchicalNav = (headings, container) => {
      ...
      const processHeadings = (parentContainer, maxLevel = 6) => {
        while (i < headingArray.length) {
          ...
          // li.style.marginLeft = `calc(var(--space-unit) * 2 * ${level - 2})`;
